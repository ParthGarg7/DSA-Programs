...
int main()
{
    ...
    int counter = insertion();

    printf("\nProgram for deletion of particular node in the list\n");

    printf("Which node you want to delete?\n");
    choice1 = node_number(counter);

    temp = head;

    for (int i = 2; i < choice1; i++)
    {
        temp = temp->next;
    }
    ...
    // printing the final list
    printf("\nThe final list after deletion is\n");
    temp = head;
    while (temp != NULL)
    {
        printf("%d ", temp->data);
